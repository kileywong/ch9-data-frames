...
most_pop_female_name_2013 <- names_2013[names_2013$pop == max(names_2013$pop, 'name')]
...
most_popular_in_year <- function(year) {
  ...
  most_popular <- names_year[ neames$year$prop == max(names_year$prop), ]
  most_popoular
}
